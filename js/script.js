...
function spin() {
  ...
  if (MagicRoaster.includes(Hasil[0])) SelectedItem = "Offer";
  if (Sepeda.includes(Hasil[0])) SelectedItem = "Offer";
  if (RiceCooker.includes(Hasil[0])) SelectedItem = "Offer";
  if (LunchBox.includes(Hasil[0])) SelectedItem = "Offer";
  if (Sanken.includes(Hasil[0])) SelectedItem = "Offer";
  if (Electrolux.includes(Hasil[0])) SelectedItem = "Offer";
  if (JblSpeaker.includes(Hasil[0])) SelectedItem = "Offer";
